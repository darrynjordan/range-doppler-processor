...
class Processor
{
	private:		
        ...
        std::string binaryFilePath;         // path to binary dataset
        std::string parameterFilePath;		// path to binary dataset
	...
	public:
        Processor(void);
        //Processor(, Timer &timer, bool debug_flag = false);
        ...
        void extractParameters(std::string filePath);
		void visualize(void);
		void initPlots(void);
        ...
        void setIsDoppler(bool IsDoppler){isDoppler = IsDoppler;}
        bool getIsDoppler(void){return isDoppler;}
        ...
        void setBinaryFilePath(std::string BinaryFilePath){binaryFilePath = BinaryFilePath;}
        std::string getBinaryFilePath(void){return binaryFilePath;}
